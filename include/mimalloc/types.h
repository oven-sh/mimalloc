...
struct mi_tld_s {
  ...
  uint32_t              holes_floor_oldest;   // the oldest clock stamp of the pages in that share (`mi_holes_clock_units`), if `holes_floor_has_oldest`
  bool                  holes_floor_has_oldest;
