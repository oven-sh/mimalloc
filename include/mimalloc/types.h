...
struct mi_tld_s {
  ...
  mi_msecs_t            holes_floor_kept_at;  // ..and the clock at the end of that sweep (0: it left nothing; `MI_HOLES_FLOOR_EXPIRED` during the sweep of a thread that stayed parked for so long after it that nothing stays)
