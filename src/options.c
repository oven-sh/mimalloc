...
static mi_option_desc_t mi_options[_mi_option_last] =
{
  ...
  { 100, MI_OPTION_UNINIT, MI_OPTION(generic_collect) },        // collect heaps every N (=100) generic allocation calls
  ...
  { 1,   MI_OPTION_UNINIT, MI_OPTION(generic_administrative) },     // perform administrative tasks every N (=1) generic allocation calls
};
